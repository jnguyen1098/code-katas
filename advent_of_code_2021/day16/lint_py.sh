...
flake8 --count --show-source --statistic --max-line-length 100 --ignore E203 "$THING"
pycodestyle --max-line-length=89 --show-source --statistics --count --max-line-length=100 --ignore E203 "$THING"
pylint "$THING"
